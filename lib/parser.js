...
(function(){
  ...
  T = {
    id: function(){
      return M.label(M.bind(M.stringOf(M.or(M.string('{}'), M.string('[]'), M.collect(M.noneOf(['.', ',', ' ', '"', '\'', '(', ')', '[', ']', '{', '}', '\n', '\r', '\t', '#']), {
        min: 1
      }))), function(it){
  ...
  P = {
    ...
    array: function(){
      return M.label(M.bind(M.between(M.and(M.string('['), T.i()), M.and(T.i(), M.string(']')), M.delay(P.messageList)), function(it){
